...
grant all privileges on buynsell.* to admin;
...
### Langkah 9
Lakukan Use database pada mysql dan Import Database buynsell.sql seperti berikut:

source /var/www/html/bikroy.com-Online-buy-sell/database/buynsell.sql
